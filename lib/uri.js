 ...
 * ```javascript
 *
 * var uri = new URI('wienchain:XsV4GHVKGTjQFvwB7c6mYsGV3Mxf7iser6?amount=1.2');
 ...
 * ```javascript
 *
 * var valid = URI.isValid('wienchain:XsV4GHVKGTjQFvwB7c6mYsGV3Mxf7iser6');
 * // true
 * ```
 *
 * @param {string|Object} data - A bitcoin URI string or an Object
