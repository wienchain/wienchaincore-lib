...
A Governance Object (or "govObject") is a generic structure introduced in Wienchain Core v12.1 to allow for the creation of Budget Proposals, Triggers, and Watch Dogs. Class inheritance has been utilized to extend this generic object into a "Proposal" which is outlined throughout the remainder of this document. 
...
####  `checkedSerialize`
Return a hex string that can be used in wienchaind CLI
####  `serialize`
Return a hex string
####  `inspect`
...
var jsonProposal = {
  ...
  payment_amount: 10,
  type: 1,
  url: "http://www.wienchain.com/proposal/first_proposal"
};
...
```javascript
proposal.url = "http://wienchain.com/badUrl"
var shallowCopyProposal = proposal.shallowCopy();
proposal.url = "http://wienchain.com/fixedUrl"
