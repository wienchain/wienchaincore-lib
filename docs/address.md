# Wienchain Address
Represents a Wienchain address. Addresses are the most popular way to make Wienchain transactions. See [the Wienchain documentation](https://dash-docs.github.io/en/glossary/address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/wienchain/wienchaincore-lib/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/wienchain/wienchaincore-lib/tree/master/lib/errors/spec.js).
