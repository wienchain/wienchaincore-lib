...
var BufferReader = wienchaincore.encoding.BufferReader;
var BufferWriter = wienchaincore.encoding.BufferWriter;

var Proposal = wienchaincore.GovObject.Proposal;
...
describe('Proposal', function() {
  ...
  it('should create new proposal', function() {
    ...
    proposal.type = 1;
    proposal.url = "http://www.wienchain.com";
  ...
  it('should throw error if payment address is P2SH', function() {
    ...
    proposal2.name = 'Proposal-36-WienchainATM';
    ...
    proposal2.type = 1;
    proposal2.url = "https://www.dashcentral.org/p/Proposal-36-WienchainATM";
