...
var HDPrivateKey = wienchaincore.HDPrivateKey;
var HDPublicKey = wienchaincore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = wienchaincore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(wienchaincore.crypto.BN.prototype, 'toBuffer').callsFake(function(args) {
      ...
      sandbox.spy(wienchaincore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      wienchaincore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = wienchaincore.PublicKey.fromPoint;
      wienchaincore.PublicKey.fromPoint = function() {
        wienchaincore.PublicKey.fromPoint = unstubbed;
