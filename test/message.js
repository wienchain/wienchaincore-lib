...
var Signature = wienchaincore.crypto.Signature;
var Message = wienchaincore.Message;

describe('Message', function() {

  var address = 'yZKdLYCvDXa2kyQr8Tg3N6c3xeZoK7XDcj';
  var badAddress = 'yj3v6A6gQkiRbChbGwvahiFZ6EfpYxk9na';
  var privateKey = wienchaincore.PrivateKey.fromWIF('cR4qogdN9UxLZJXCNFNwDRRZNeLRWuds9TTSuLNweFVjiaE4gPaq');
  ...
  it('will verify with an uncompressed pubkey', function() {
    var privateKey = new wienchaincore.PrivateKey('67fd2209ce4a95f6f1d421ab3fbea47ada13df11b73b30c4d9a9f78cc80651ac');
