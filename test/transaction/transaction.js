...
var BN = wienchaincore.crypto.BN;
var Transaction = wienchaincore.Transaction;
var Input = wienchaincore.Transaction.Input;
var Output = wienchaincore.Transaction.Output;
var PrivateKey = wienchaincore.PrivateKey;
var Script = wienchaincore.Script;
var Address = wienchaincore.Address;
var Opcode = wienchaincore.Opcode;
var errors = wienchaincore.errors;
var Payload = wienchaincore.Transaction.Payload;
...
describe('Transaction', function() {
  ...
  it('fromObject with pay-to-public-key previous outputs', function() {
    var tx = wienchaincore.Transaction({
    ...
    tx.inputs[0].should.be.instanceof(wienchaincore.Transaction.Input.PublicKey);
  ...
  describe('checks on adding inputs', function() {
    ...
    it('will add an empty script if not supplied', function() {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(wienchaincore.Script);
  ...
  describe('fromObject', function () {
    it('Should copy transaction when passing instance of Transaction as arg', function() {
      ...
      var copiedTransaction = wienchaincore.Transaction().fromObject(tx);
      expect(copiedTransaction).to.be.an.instanceof(wienchaincore.Transaction);
    });
  });
